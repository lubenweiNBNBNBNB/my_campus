...
public class wsfwActivity extends AppCompatActivity
{
    private List<NewsClass> ItemList = new ArrayList<>();
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, wsfwActivity.class);
    ...
    {
        NewsClass business1 = new NewsClass("图书馆");
        ItemList.add(business1);
        business1 = new NewsClass("校园网络");
        ItemList.add(business1);
        business1 = new NewsClass("自助服务");
        ItemList.add(business1);
